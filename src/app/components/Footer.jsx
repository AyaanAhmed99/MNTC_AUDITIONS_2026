...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#0b0f1a] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-14 flex flex-col items-center text-center gap-6">

        {/* Club Identity */}
        <h2 className="text-2xl font-semibold tracking-wide">
          Maths N Tech Club
          <span className="block text-sm text-indigo-400 font-medium tracking-wider mt-1">
          ...
          {socialLinks.map(({ icon: Icon, href, label }) => (
            ...
            >
              <div className="w-12 h-12 rounded-full 
                ...
                <Icon className="w-5 h-5 text-gray-300 transition-colors duration-300 group-hover:text-indigo-400" />
              </div>
            </a>
          ))}
        </div>
        ...
        {/* Divider */}
        <div className="w-full max-w-lg h-px bg-gradient-to-r from-transparent via-gray-600/40 to-transparent mt-6" />
