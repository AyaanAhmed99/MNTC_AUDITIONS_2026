...
export default function Cells() {
  const cells = [
    ...
    },
    {
      ...
      domains: ["Graphic Design", "Video Editing"],
    ...
    },
    {
      ...
      domains: ["Web Development", "Research and Development"],
    ...
    },
    {
      ...
      domains: ["Content", "Finance Enthusiast"],
      gradient: "from-yellow-500 to-orange-500",
    },
  ];

  return (
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="grid gap-6 sm:gap-8 md:gap-10 md:grid-cols-2">
          {cells.map((cell) => {
            ...
            return (
              <div
                key={cell.title}
                className="bg-white rounded-3xl shadow-xl p-6 sm:p-8 hover:-translate-y-2 transition duration-300"
              >
                {/* Icon */}
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-r ${cell.gradient} flex items-center justify-center text-white mb-4 sm:mb-5`}
                >
                  <Icon size={26} />
                </div>
                ...
                <div className="mt-4">
                  ...
                  <ul className="space-y-1 list-disc list-inside text-gray-700 text-sm sm:text-base">
